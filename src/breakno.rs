...
impl InstructionCircuit for BreakNoCircuit {
...
impl ConstraintSynthesizer<Fr> for BreakNoCircuit {
    fn generate_constraints(
        ...
        read_var.enforce_equal(&FpVar::Constant(Fr::from(0)))?;
        ...
        inputs_pc.push(FpVar::Constant(Fr::from(7)));
        inputs_pc.push(FpVar::Constant(Fr::from(0)));
